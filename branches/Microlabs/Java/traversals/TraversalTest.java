...
public class TraversalTest
{
    Node tree;
    static int maxPos;
    TraversalSolution solution = new TraversalSolution();

    public TraversalTest(String nonce)
    {
        boolean correct = true;
        for (int i = 0; i < 3; i++)
        {
            tree = buildRandomTree();
            TraversalStudent student = new TraversalStudent();
