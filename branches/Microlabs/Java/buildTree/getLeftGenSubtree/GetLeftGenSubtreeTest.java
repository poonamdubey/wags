 ...
 * @date: Mar 17, 2012
 * @file: GetLeftGenSubtreeTest.java
 *
 * Description: Test class for getLeftGenSubtree sub-exercise
 */
import java.util.Random;

public class GetLeftGenSubtreeTest
{
    ...
    public GetLeftGenSubtreeTest(String nonce)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            displayVTree(tree);
            sol.getLeftGenSubtreeSolution(preOrder, inOrder);
            theirs.getLeftGenSubtreeStudent(preOrder, inOrder);
            System.out.println("Correct Left Subtree PreOrder Traversal: " + sol.leftPreorder);
            System.out.println("Correct Left Subtree inOrder Traversal: " + sol.leftInorder);
            System.out.println("Your Left Subtree PreOrder Traversal: " + theirs.leftPreorder);
            System.out.println("Your Left Subtree inOrder Traversal: " + theirs.leftInorder  + "\n");
            if (!sol.leftPreorder.equals(theirs.leftPreorder) ||
