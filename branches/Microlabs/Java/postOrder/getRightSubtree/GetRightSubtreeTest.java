 ...
 * @date: Mar 16, 2012
 * @file: GetRightSubtreeTest.java
 *
 * Description: Test class for getRightSubtree sub-exercise.
 */
import java.util.Random;

public class GetRightSubtreeTest
{
    static int maxPos;
    ...
    public GetRightSubtreeTest(String nonce)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            displayVTree(tree);
            String correct = sol.getRightSubtree(testString);
            String student = theirs.getRightSubtree(testString);
            System.out.println("Correct Right Subtree String: " + correct);
            System.out.println("Your Right Subtree String: " + student);
