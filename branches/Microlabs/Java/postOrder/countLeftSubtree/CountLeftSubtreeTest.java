 ...
 * @date: Mar 16, 2012
 * @file: CountLeftSubtreeTest.java
 *
 * Description: Test class for countLeftSubtree sub-exercise.
 */

import java.util.Random;

public class CountLeftSubtreeTest
{
    ...
    public CountLeftSubtreeTest()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            displayVTree(tree);
            int correct = sol.countLeftSubtree(testString);
            int student = theirs.countLeftSubtree(testString);
            System.out.println("Correct Left Subtree Count: " + correct);
            System.out.println("Your Left Subtree Count: " + student);
            if (correct != student)
                allRight = false;
        }
