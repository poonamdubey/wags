...
/**
 * This is the test class for the Delete F# exercise
 * 
 * @author Mike Dusenberry
 * @date 07/27/12
 * @file DeleteTestClass.java
 *
 */
public class DeleteTestClass {
    ...
    public static void main(String args[]) {
        ...
        new DeleteTestClass(nonce, solutionExecString, studentExecString);
    }
     ...
     *
     */
    public DeleteTestClass(String nonce, String solutionExecString, String studentExecString)
    {
        ...
        for (i = 0; i < 4; i++)
        {
            ...
            // get rid of last space, and replace spaces with commas
            list = list.trim().replaceAll(" ", ",");
    ...
    { 
        ...
        System.out.println("Value To Remove:     " + num);
