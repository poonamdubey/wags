...
/**
 * This is the test class for the ReverseList Prolog exercise
 * 
 * @author Mike Dusenberry
 * @date 03/20/12
 * @file ReverseListTestClass.java
 *
 */
public class ReverseListTestClass {
    ...
    { 
        String args = "" + list; // list is already a string, but just keeping code consistent
        ...
        System.out.println("Correct Reversed List: " + solutionOutput);
        System.out.println("Your Reversed List:    " + studentOutput + "\n");
