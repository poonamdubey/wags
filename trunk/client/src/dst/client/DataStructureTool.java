...
{	
	...
	{
		//Have to change this to a DST specific call
		//in order to link methods in the on success
		//calls
		
		//How this works is this.method() calls Proxy.somemethod(),
		//and then Proxy.somemethod() calls the next this.method()
		//Thus you can see the chain of calls from this class,
		//and don't have to just trudge through proxy
		
		Proxy.getUsersName(welcomeLabel); //sets welcome label
	}
	 ...
	 *
	 *Called from Proxy.getDSTUserName();
	 */
	public void getProblems()
	{
		Proxy.getProblems(problemList);				
		getProblemResults();
	}
